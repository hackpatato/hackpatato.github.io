---
description: How am I learning maldevelopment and coding?
---

# How am I learning maldevelopment and coding?



{% embed url="https://canva.link/vfnimagsq6fs5bk" %}
...
1. You will **only** use this tool against systems that you **own** or have received **explicit written authorization** from the system owner to test.
2. Unauthorized use is **illegal** under applicable law, including but not limited to:
